...
enum xmrstak_algo
{
	...
	cryptonight_electronero = 8, //equal to cryptonight_monero but with less iterations, used by electronero
	cryptonight_pulse = 8, //equal to cryptonight_electronero, used by electronero pulse
